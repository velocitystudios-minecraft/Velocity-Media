...
import fr.velocity.music.dependency.classloader.DependencyClassLoader;
...
public class DependencyManager {
	...
	private static Path createExtractDirectory() {
		try {
			final Path baseDirectory = Paths.get(System.getProperty("java.io.tmpdir", "/tmp"), Main.modid + "-extraction-tmp");
			...
			try {
				return Files.createTempDirectory(Main.modid + "-extraction-tmp");
